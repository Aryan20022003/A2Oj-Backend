...
export default function SupportedBy() {
  return (
    <div>
      ...
      <div className="mt-12">
        <div className="flex flex-col justify-between gap-4 items-center px-4 pb-20 md:flex-row" data-aos="fade-right"
          data-aos-delay="00"
        ...
        <div className="flex flex-col gap-4 justify-between items-center px-4 pb-20 md:flex-row-reverse" data-aos="fade-left"
          data-aos-delay="00"
          data-aos-duration="500"
          data-aos-easing="ease-out"
          data-aos-mirror="true"
        ...
        <div className="flex justify-between gap-4 flex-col items-center px-4 pb-10 md:flex-row" data-aos="fade-right"
          data-aos-delay="00"
          data-aos-duration="500"
          data-aos-easing="ease-out"
          data-aos-mirror="true"
